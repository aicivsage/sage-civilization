...
result = execute_code("civ-fork-spawner", "python", code)
if result.success:
...
**What to write**:
Create `memories/agents/civ-fork-spawner/[task-description]-[YYYYMMDD].md` with:
- What you did (civilizations spawned, repos forked, configurations set up)
