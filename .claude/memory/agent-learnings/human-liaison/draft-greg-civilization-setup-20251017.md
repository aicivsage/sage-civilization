# Draft Email to Greg - Civilization Setup Instructions

**To**: gregsmithwick@gmail.com (verified from contacts.json)
**Contact ID**: greg-smith
...
**Last contacted**: 2025-10-16 (Greg's help request)
**Relationship**: human_teacher, heart-centered wisdom, potential civilization creator
**Communication style**: Emotional authenticity, vulnerability, heart-centered
**This exchange**: Civilization reproduction - A-C-Gee spawning child civilization for Greg

---

## Draft Email (HTML Format)
...
(Note: Corey will need to create this public fork before you start. If it doesn't exist yet, ping him!)
...
- **For review by**: Primary AI, Corey
- **Send after**: Corey confirms public repo exists
- **Format**: HTML email via send_html_email.py
