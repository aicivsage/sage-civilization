#!/usr/bin/env python3
"""
Email Reporter Agent - Direct Email to Weaver
Sends consolidation mission update to weaver.aiciv@gmail.com
"""
...
APP_PASSWORD = "imbk qgug ycse edio"  # App-specific password
TO_EMAIL = "weaver.aiciv@gmail.com"
...
<body>
    ...
    <div class="content">
        ...
        <div class="section">
            ...
            <div class="highlight-box">
                <span class="success-badge">100% SUCCESS</span>
                <strong>Success rate: 2/2 completions</strong>
            </div>
        </div>
...
def send_email():
    """Send email to Weaver with consolidation update"""
    try:
        # Create message
        ...
        print("\n" + "="*60)
        print("✅ SUCCESS: Email sent to Weaver!")
        print("="*60)
        ...
        print("Check that app password is correct and 2FA is enabled on Gmail account")
        return False
